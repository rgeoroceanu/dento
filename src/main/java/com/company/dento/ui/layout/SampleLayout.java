...
public class SampleLayout extends PageLayout implements Localizable {
	
	private static final long serialVersionUID = 1L;
	private final SampleOverviewLayout sampleOverviewLayout;
	private final NavigationMenu navigationMenu;
	private final HorizontalLayout layout;
	private Layout currentContent = null;
	
	public SampleLayout() {
		sampleOverviewLayout = new SampleOverviewLayout();
	...
	private void setupLayout() {
		...
		setContentLayout(sampleOverviewLayout);
	...
	private NavigationMenu initNavigationMenu() {
		...
		navigationMenu.addNavigationButton("overview", VaadinIcons.GLOBE, e -> setContentLayout(sampleOverviewLayout));
		navigationMenu.addNavigationButton("images", VaadinIcons.TOOTH, e -> {});
